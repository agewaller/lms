...
var AIEngine = {
  ...
  // MODEL_MAP: translate CONFIG model IDs to dated Anthropic/OpenAI/Google API IDs.
  // Update this map when providers rotate model IDs — one change propagates everywhere.
  MODEL_MAP: {
