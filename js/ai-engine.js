...
var AIEngine = {
  ...
  // Maps CONFIG model keys → provider API IDs.
  // Update here only when Anthropic/OpenAI/Google rotates IDs.
  // Unknown keys fall through to themselves for forward compatibility.
  MODEL_MAP: {
