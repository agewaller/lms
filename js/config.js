...
※投資は自己責任です。必ず専門家にご相談ください。`
  ...
  // ─── Daily Journaling Prompts (循環・domain別) ───
  dailyPrompts: {
    consciousness: [
      '今日、心が一番落ち着いていた瞬間はいつですか？',
      '今日、感謝したいことを3つ思い浮かべてみてください。',
      '最近、頭から離れない考えや悩みはありますか？',
      '今日、自分らしくいられた場面はどんな時でしたか？',
      '今週、誰かのためにできたことはありましたか？',
      '自分の気持ちを色に例えると、今日は何色ですか？',
      '今日の「静かな喜び」は何でしたか？',
      '今日、美しいと感じたものは何かありましたか？',
      '最近、怒りや悲しみを感じた出来事はありましたか？どう乗り越えましたか？',
      '今の自分にとって「本当に大切なこと」は何ですか？',
      '過去1ヶ月で、一番嬉しかった瞬間を思い出せますか？',
      '今日、誰かに「ありがとう」と言えましたか？',
      '10年後の自分に、何か伝えたいことはありますか？',
      '最近、心が穏やかでない時間はありますか？何が原因だと思いますか？',
      '今日、新しいことを学んだり気づいたりしましたか？',
      '「もっとこうすれば良かった」と思うことはありますか？',
      '今、自分の一番の「強み」は何だと感じますか？',
      '最近、自然や季節の変化を感じましたか？',
      '今日、何か笑いましたか？何が楽しかったですか？',
      '「これが自分を支えている」と感じるものは何ですか？',
      '今日、誰かの優しさに気づきましたか？',
      '最近、心が動いた（感動した）ことはありましたか？',
      '朝目覚めたとき、最初に感じた気持ちは何でしたか？',
      '今の自分にとって「休む」とはどういうことですか？',
      '最近、自分を責めすぎていることはありますか？',
      '今日の終わりに、自分を褒めてあげたいことは何ですか？',
      '「また会いたい」と思う人は誰ですか？',
      '今、あなたの心に重くのしかかっていることは何ですか？',
      '最近、昔を懐かしむ気持ちになりましたか？どんな記憶ですか？',
      '今日という日を一言で表すとしたら、どんな言葉ですか？'
    ],
    health: [
      '今日、体が一番楽に感じた時間帯はいつでしたか？',
      '昨夜の睡眠はどうでしたか？夢は見ましたか？',
      '今日の食事で、体に嬉しいものを食べましたか？',
      '体を動かしましたか？どんな動きが気持ち良かったですか？',
      '痛みや違和感はありますか？どの部位が気になりますか？',
      '今日のお薬やサプリメントは飲めましたか？',
      '今の体調を10点満点で表すと、何点ですか？',
      '今日、水分は十分に取れましたか？',
      '最近、食欲はありますか？何が食べたいですか？',
      '血圧や体重など、気になる数値の変化はありますか？',
      '最近、疲れが取れない日が続いていますか？',
      '今日の天気と体調の関係を感じましたか？',
      '最近、「これが体に良いかも」と感じた食べ物や習慣はありますか？',
      '今日、外に出ましたか？どのくらい歩きましたか？',
      '最近、体のどこかが「前より良くなった」と感じることはありますか？',
      '今日、体が緊張していた場所はありますか？（肩、首など）',
      '最近、「元気だな」と感じた日はいつですか？',
      '今日の食事は規則正しく食べられましたか？',
      '最近、医師や薬剤師に相談したいことはありますか？',
      '今日、体に感謝したいと思ったことはありますか？',
      '最近、転倒しそうになったり、ふらつきを感じましたか？',
      '寝る前のルーティンはありますか？それは守れていますか？',
      '今日、誰かと一緒に食事をしましたか？',
      '最近、体重や体型の変化を感じましたか？',
      '今日、深呼吸をする余裕はありましたか？',
      '最近の体の悩みで、一番気になっていることは何ですか？',
      '今日は何時間眠れましたか？十分だと感じますか？',
      '最近、気になる症状（めまい、むくみなど）はありますか？',
      '今日、自分の体に「がんばったね」と言いたい場面はありましたか？',
      '体の調子が良いとき、何が違うと思いますか？'
    ],
    time: [
      '今日、一番充実していた時間はどんな時間でしたか？',
      '最近、「時間を忘れて」取り組んでいることはありますか？',
      '今日、無駄だったと感じた時間はありますか？',
      '明日、真っ先にやりたいことは何ですか？',
      '最近、新しいことを始めましたか？どんなことですか？',
      '今日、誰かと一緒に過ごした時間はありましたか？',
      '自分だけの「楽しみ時間」は取れていますか？',
      '今日のうちに片づけたいことはありますか？',
      '最近、「もっと時間があれば」と思ったことは何ですか？',
      '今週、一番楽しみにしていることは何ですか？',
      '朝起きてから就寝までの「流れ」はうまく回っていますか？',
      '最近、趣味や好きなことに使った時間はありましたか？',
      '今日、予定していたけれどできなかったことはありますか？',
      '「もっとゆっくりしたい」と思う場面はありますか？',
      '今日、誰かを待つ時間がありましたか？それをどう使いましたか？',
      '最近、「時間が足りない」と感じる原因は何ですか？',
      '今日、どんな小さなことでも「やり切った」ことはありますか？',
      '一日の中で、一番「自分らしい」と思える時間帯はいつですか？',
      '今週の中で「あの時間は良かった」と思える瞬間はありましたか？',
      '最近、誰かと「ゆっくり話す」時間は取れていますか？',
      '今日、何かを後回しにしましたか？',
      '昨日より今日の方が「上手く時間を使えた」と感じますか？',
      '最近、「急ぎすぎている」と感じることはありますか？',
      '今日の朝、どんな気持ちで一日を始めましたか？',
      '今月、楽しみにしている予定はありますか？',
      '「あの時間、意味があったな」と最近感じたことはありますか？',
      '今日、自然の中で過ごす時間はありましたか？',
      '今日、自分の「ペース」で過ごせましたか？',
      '最近、時間の使い方で「これは変えたい」と思うことはありますか？',
      '今日が終わる前にしておきたいことは何ですか？'
    ],
    work: [
      '今日、自分の「強み」を感じた場面はありましたか？',
      '誰かの役に立てた、と感じたことはありますか？',
      '最近、やってみたいことや挑戦したいことはありますか？',
      '今の仕事（活動）で、楽しいと感じる部分は何ですか？',
      '若い頃の経験で、今も活かせることはありますか？',
      '地域や社会でやってみたいことはありますか？',
      '「もっとこうしたい」と思う仕事上のことはありますか？',
      '最近、「自分が必要とされている」と感じた場面はありますか？',
      '今日、誰かに何かを教えたり伝えたりしましたか？',
      '仕事（活動）を通じて、最近気づいたことはありますか？',
      '今の生活で「生きがい」だと感じることは何ですか？',
      '退職後の生活で、一番良かったことは何ですか？',
      '最近、地域や社会のために何かしましたか？',
      '昔の職業経験が、今の生活に役立っていることはありますか？',
      '今日、新しい人と話したり出会いがありましたか？',
      '「これが得意だ」と感じることで、周りに貢献できそうなことは何ですか？',
      '最近、ボランティアや地域活動に参加しましたか？',
      '仕事（活動）の中で、今一番楽しみにしていることは何ですか？',
      '今の自分が一番大事にしている「働く理由」は何ですか？',
      '最近、自分の能力や知識が向上したと感じましたか？',
      '誰かに「ありがとう」と言われた体験は最近ありましたか？',
      '今の仕事（活動）で、改善したいと思っていることはありますか？',
      '将来、どんなことに関わっていたいですか？',
      '今日、達成感を感じた瞬間はありましたか？',
      '最近、「やりがい」を感じたのはどんな時でしたか？',
      '社会や誰かに伝えたいことや残したいことはありますか？',
      '今の「仕事」（趣味や活動も含む）で、特に楽しい瞬間はいつですか？',
      '最近、「もっとうまくやれた」と思う場面はありましたか？',
      '今日の活動を通じて、何か新しいことを学びましたか？',
      '自分の経験や知識を次の世代に伝えたいと感じることはありますか？'
    ],
    relationship: [
      '最近、連絡を取っていない大切な方はいますか？',
      '今日、誰かを笑顔にできましたか？',
      '最近、新しい出会いや縁がありましたか？',
      '大切な人に「ありがとう」と伝えられていますか？',
      '困ったとき、頼れる人はいますか？',
      '今、誰かのことが少し心配ですか？',
      '一緒にいると元気になれる人は誰ですか？',
      '最近、家族や友人と話しましたか？どんな話をしましたか？',
      '今日、誰かに親切にしてもらいましたか？',
      '久しぶりに会いたい人がいますか？どんな方ですか？',
      '最近、人間関係で悩んでいることはありますか？',
      '今日、誰かのために何かしてあげましたか？',
      '大切な人を「守りたい」と感じることはありますか？',
      '最近、孤独を感じることはありますか？',
      '誰かに連絡しようと思いながら、まだできていない方はいますか？',
      '今日、笑顔で話せた人はいますか？',
      '最近、地域の人たちとの関わりはありますか？',
      '一番「感謝している人」は誰ですか？その方に伝えていますか？',
      '最近、誰かのために時間を使いましたか？',
      '今日、誰かと共感できた瞬間はありましたか？',
      '人間関係で「こうなりたい」と思う理想はありますか？',
      '最近、人と話すことで元気をもらいましたか？',
      '大切な人との思い出で、最近ふと思い出したことはありますか？',
      '今日、誰かの言葉が心に残りましたか？',
      '友人・家族に「最近どうですか？」と声をかけましたか？',
      '今の自分の人間関係で、大切にしていることは何ですか？',
      '最近、集まりや食事会などに参加しましたか？',
      '今日、誰かと一緒に笑いましたか？',
      '誰かに「会いに行こう」と思いながらまだ行けていない場所はありますか？',
      '今日の自分の「つながり」を一言で表すとしたら？'
    ],
    assets: [
      '今月の支出で、「これは良かった」と思うものはありますか？',
      '老後のお金について、今一番気になっていることは何ですか？',
      '最近、節約できた出費はありますか？',
      'NISAや投資について、気になっていることはありますか？',
      '毎月の収支は把握できていますか？',
      '将来のために、今できることは何だと思いますか？',
      '「お金があったら何をしたいか」、思い浮かぶことはありますか？',
      '今月、予想外の出費はありましたか？',
      '老後の生活費として、月どのくらいを想定していますか？',
      '最近、保険の内容を確認しましたか？',
      '「節約したいけれどできていないこと」はありますか？',
      '今月の食費・光熱費は例月と比べてどうでしたか？',
      '最近、医療費や薬代の支出はどうですか？',
      '将来、子どもや孫のために残したいものはありますか？',
      '今の収入と支出のバランスはどうですか？',
      '最近、大きな買い物をしましたか？後悔はありますか？',
      '「お金の管理で助けてほしい」と感じることはありますか？',
      '年金以外の収入源について考えたことはありますか？',
      '今の資産状況で、一番不安なことは何ですか？',
      '最近、「これは良い買い物だった」と思えるものはありますか？',
      '老後の住まいについて考えたことはありますか？',
      '今月、外食や娯楽にかけた費用は適切でしたか？',
      '家の修繕・維持費用について、備えはできていますか？',
      '最近、詐欺や不審な勧誘に遭ったことはありますか？',
      '今の家計で「見直したい」と感じている項目はありますか？',
      '「贅沢」と「必要」の線引きを、最近どこで引きましたか？',
      '今月、誰かに金銭的な援助をしましたか？または受けましたか？',
      '将来の介護費用について、何か準備していますか？',
      '今の経済状況で「安心できている部分」は何ですか？',
      '10年後の自分のためにできる、小さな一歩は何ですか？'
    ]
  }
};
