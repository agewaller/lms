...
※投資は自己責任です。必ず専門家にご相談ください。`
    ...
    health_doctor_memo: {
      name: 'お医者さんへのメモ作成',
      description: '最近の健康記録を診察メモに変換する',
      prompt: `以下はユーザーの最近の健康記録です。これをもとに、次の診察でお医者さんに伝えるべきことをわかりやすくまとめてください。

【まとめ方のルール】
・「患者さん自身が読めばそのままお医者さんに見せられる」文章にする
・専門用語は使わない。小学5年生でもわかる言葉で
・伝える順番: ①最も気になる症状 ②最近の体調の変化（改善・悪化） ③睡眠・食事・運動の状況 ④服薬状況 ⑤先生への質問（もしあれば）
・箇条書きで簡潔に。200〜400文字程度
・最後に「先生に聞いてみましょう」という質問を1〜2個添える
