      ...
      html += `<div class="prompt-item ${p.active === false ? 'inactive' : ''}" data-key="${key}">
        <div class="prompt-header">
          ...
          <div class="prompt-actions">
            <button class="btn btn-sm btn-secondary" onclick="app.editPrompt('${Components.escapeHtml(key)}')">編集</button>
          </div>
        </div>
        <div class="prompt-desc">${Components.escapeHtml(p.description || '')}</div>
        <div class="prompt-edit" id="edit-${Components.escapeHtml(key)}" style="display:none;">
          <div class="form-group">
            <label>名前</label>
          ...
          <div class="form-actions">
            <button class="btn btn-primary" onclick="app.savePrompt('${Components.escapeHtml(key)}')">保存</button>
            <button class="btn btn-secondary" onclick="app.cancelPromptEdit('${Components.escapeHtml(key)}')">キャンセル</button>
            <button class="btn btn-danger" onclick="app.deletePrompt('${Components.escapeHtml(key)}')">削除</button>
          </div>
        </div>
      </div>`;
    });
