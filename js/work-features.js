...
むずかしい言葉は使わないでください。`;
  ...
  async diagnose() {
    ...
    const prompt = `以下の方に合う活動プランを3つ提案してください。

【ご経験・職歴】${experience}
【お得意なこと・好きなこと】${skills}
【使える時間】${time}
【提供方法】${mode === 'online' ? '家からオンライン' : mode === 'offline' ? '直接会って' : 'どちらでも'}
【目標収入】${income}
【アプリ・IT経験】${ai}
...
むずかしい言葉は使わないでください。難しい用語には必ず（　）で説明を添えてください。`;
  ...
  renderTimeSellingBanner() {
    ...
    return `<div class="time-selling-banner">
      ...
      <div class="tsb-content">
        ...
        <p>カレンダーの空き時間を自動で計算し、スキルを必要としている方に提供できます。</p>
      </div>
