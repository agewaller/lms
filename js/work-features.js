...
むずかしい言葉は使わないでください。`;
  ...
  renderSideBizDiagnosis() {
    return `<div class="sidebiz-diagnosis">
      <h3>副業・活動 診断</h3>
      <p>これまでの経験や好きなことを教えてください。あなたにぴったりの活動を見つけます。</p>

      <div class="diagnosis-form">
        <div class="form-group">
          <label>ご経験・職歴</label>
          <textarea id="diagExperience" class="form-input" rows="3"
            placeholder="例：看護師を30年、会社で経理、主婦として家族を育てた、料理教室を開いていた"></textarea>
        </div>
  ...
  async diagnose() {
    ...
    const prompt = `65歳以上の方から副業の相談です。以下の情報をもとに、副業プランを3つ提案してください。
...
1. 副業の名称とわかりやすい説明
2. 必要な準備（具体的なステップ）
3. 使うツール（アプリやサイト名）とその使い方
4. 想定月収（現実的な金額）
5. 始めるまでの期間
6. 最初の一歩（今日から15分でできること）

まったくの初心者にも伝わるよう、やさしい言葉で。
