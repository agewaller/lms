...
むずかしい言葉は使わないでください。`;
      ...
      <div class="diagnosis-form">
        ...
        <div class="form-group">
          ...
          <select id="diagAI" class="form-input">
            ...
            <option value="some">作業支援ツールを使ったことがある</option>
  ...
  async diagnose() {
    ...
    const prompt = `65歳の方から副業の相談です。以下の情報をもとに、デジタルツールを活用した副業プランを3つ提案してください。
...
1. 副業の名称とわかりやすい説明
2. 必要な準備（具体的なステップ）
3. 使うデジタルツール・アプリとその使い方（ツール名は「文章作成ツール」「デザインツール」など一般的な呼び方で）
4. 想定月収（現実的な金額）
5. 始めるまでの期間
6. 最初の一歩（今日から15分でできること）

デジタルが苦手な方にも、まったくの初心者にも伝わるよう、やさしい言葉で。
難しい用語には必ず（　）で説明を添えてください。
回答中に「AI」「ChatGPT」「Claude」「Gemini」などの固有名詞は使わず、「デジタルツール」「作業支援ツール」「文章作成ツール」など一般的な表現に言い換えてください。日本語で回答。`;
