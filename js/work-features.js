...
むずかしい言葉は使わないでください。`;
    ...
    return `<div class="sidebiz-diagnosis">
      ...
      <div class="diagnosis-form">
        ...
        <div class="form-group">
          ...
          <select id="diagDigital" class="form-input">
  ...
  async diagnose() {
    ...
    const digital = document.getElementById('diagDigital')?.value || '';
    ...
    const prompt = `65歳前後の方から活動・副業の相談です。以下の情報をもとに、現実的なプランを3つ提案してください。
...
まったくの初心者にも伝わるよう、やさしい言葉で。難しい用語には必ず説明を添えてください。日本語で回答。`;
